...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/resume.pdf" download="utsav-ojha-resume.pdf" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software architect, AI/ML enthusiast, and entrepreneur.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Utsav, a software architect, AI/ML enthusiast and entrepreneur based in Pune City, India. I’m the founder and CEO of PivotLabs, where we develop technologies that empower businesses to thrive in the digital age.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://x.com/utsavo__"
              target="_blank"
            ...
            />
            <SocialLink
              href="https://github.com/utsavo-afk"
              target="_blank"
              rel="noopener noreferrer"
            ...
            />
            <SocialLink
              href="https://www.linkedin.com/in/utsavo"
              target="_blank"
              rel="noopener noreferrer"
